        ...
        <View style = {{flex: 1}}>
            <View style = {styles.container}>
                ...
                <View style = {[styles.recommend, {flex: 1.8,}]}>
                    <TouchableOpacity style = {styles.recommendBtn} onPress={()=> (userRecommendInfo.userIndex == 10) ? (Alert.alert("", "모든 문제를 풀었습니다 다음에 도전하세요.")): (navigation.navigate("RecommendStudy", {userRecommendInfo: userRecommendInfo, setUserRecommendInfo: setUserRecommendInfo, querySnapshot: querySnapshot, userInfo: userInfo})) }>
